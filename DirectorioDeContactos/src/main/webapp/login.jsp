...
<section class="py-3 py-md-5 py-xl-8">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="mb-5">
          <h2 class="display-5 fw-bold text-center">Ingresar</h2>
          <p class="text-center m-0">No tienes una cuenta? <a href="#!" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ingresar</a></p>
        </div>
      </div>
    </div>
              ...
              <div class="row gy-3 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="row justify-content-between">
                    ...
                    <div class="col-6">
                      <div class="text-end">
                        <a href="#!" class="link-secondary text-decoration-none">Crear cuenta</a>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="SvRegisterLogin">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label" name="correo" required>Correo Electronico</label>
          <input type="email" class="form-control" aria-describedby="emailHelp">
          <div class="form-text">No compartiremos tu correo con nadie.</div>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label" name="contraseña" required>Contraseña</label>
